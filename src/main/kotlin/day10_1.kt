...
fun main() {
    ...
    val inLines = readInput("test10_1")
    ...
    fun trouveSuite(element:Element) : MutableSet<Element> {
        var lstRetour = mutableSetOf<Element>()
        var dep = element.dep
    ...
    lstZeros.forEach { it ->
        val listeElements = mutableSetOf<Element>()
