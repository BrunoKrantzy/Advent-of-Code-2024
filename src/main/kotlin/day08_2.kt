    ...
    lstListes.forEach { lst ->
        for (i in 0 until lst.size - 1) {
            ...
            for (j in i + 1 until lst.size) {
                ...
                var node1x = p1.x - diffX
                var node1y = p1.y - diffY
                while (node1x in 1..maxX && node1y in 1..maxY) {
                ...
                var node2x = p2.x + diffX
                var node2y = p2.y + diffY
                while (node2x in 1..maxX && node2y in 1..maxY) {
